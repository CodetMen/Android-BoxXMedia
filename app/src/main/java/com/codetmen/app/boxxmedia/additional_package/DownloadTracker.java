package com.codetmen.app.boxxmedia.additional_package;
...
public class DownloadTracker  implements DownloadManager.Listener {
    ...
    private void startServiceWithAction(DownloadAction action) {
        DownloadService.startWithAction(context, OneMediaDownloadService.class, action, false);
    }
    ...
    private final class StartDownloadDialogHelper
        ...
        public void onPrepareError(DownloadHelper helper, IOException e) {
            Toast.makeText(context.getApplicationContext(), R.string.download_start_error, Toast.LENGTH_LONG)
                    .show();
        }
